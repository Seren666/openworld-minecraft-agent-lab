...
| MineStudio minimal workflow smoke test | install/import/module/simulator check | Ran a clean no-deps editable install, top-level import, module inventory, and simulator readiness check on AutoDL. | import/module smoke test passed; simulator rollout blocked by missing dependency and display/runtime support | `docs/minestudio_smoke_test.md`, `experiments/minestudio-smoke-test/` |
