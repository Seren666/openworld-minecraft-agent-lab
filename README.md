...
| OpenHA/CrossAgent Action-Space Taxonomy | metadata/sample-based quantitative analysis | Classified 1200 Minecraft task names by category, interface pressure, required information, and fixed-action-space failure mode. | Completed / preliminary | `docs/action_space_taxonomy_analysis.md`, `experiments/openha-action-space-analysis/` |
