...
6. For MineStudio, test a Blackwell-compatible PyTorch install and display support before any simulator reset attempt.
...
| MineStudio workflow | Add PyTorch and display support only after import-level checks remain bounded, then attempt a tiny reset/step workflow. |
